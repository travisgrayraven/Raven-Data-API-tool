...
export const CredentialsForm: React.FC<CredentialsFormProps> = ({ onSubmit, isLoading }) => {
  ...
  return (
    <div className="max-w-md mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden md:max-w-2xl p-8">
      <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 text-center">{t('credentialsForm.title')}</h2>
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          <label htmlFor="apiUrl" className="block text-sm font-medium text-gray-700 dark:text-gray-300">{t('credentialsForm.apiUrl')}</label>
          <input
            type="text"
            id="apiUrl"
            value={apiUrl}
        ...
        <div>
          <label htmlFor="apiKey" className="block text-sm font-medium text-gray-700 dark:text-gray-300">{t('credentialsForm.apiKey')}</label>
          <input
            type="text"
            id="apiKey"
            value={apiKey}
        ...
        <div>
          <label htmlFor="apiSecret" className="block text-sm font-medium text-gray-700 dark:text-gray-300">{t('credentialsForm.apiSecret')}</label>
          <input
            type="password"
            id="apiSecret"
            value={apiSecret}
