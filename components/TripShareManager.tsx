        ...
        <div className="space-y-3">
          <div className="flex items-center gap-2">
            <input
              ...
              readOnly
              value={shareUrl}
              className="block w-full bg-gray-100 dark:bg-slate-700 border border-gray-300 dark:border-slate-600 rounded-md shadow-sm py-2 px-3 text-sm"
            />
            <button
                onClick={handleCopyToClipboard}
                className="py-2 px-3 border border-gray-300 dark:border-slate-600 rounded-md shadow-sm text-sm font-medium bg-white dark:bg-slate-800 hover:bg-gray-50 dark:hover:bg-slate-700"
            >
                {copySuccess ? 'Copied!' : 'Copy'}
            </button>
            <button
                onClick={() => setIsQrModalOpen(true)}
                className="p-2 border border-gray-300 dark:border-slate-600 rounded-md shadow-sm bg-white dark:bg-slate-800 hover:bg-gray-50 dark:hover:bg-slate-700"
